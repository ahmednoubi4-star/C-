...
int main() {
    ...
    //make a task done
       ...
       int c = tasks.size();
       vector <string> v (c);
        cout<<" enter the number of the task you did or 0 to quit "<<endl;
             for(int i =0 ; i < tasks.size() ; i ++){
                cout<<i+1<<". "<<tasks[i]<<endl;
             }
             while(r){
           ...
           break;} 
        case 4:{
            cout<<"Enter the number of the task you want to delete, or 0 to quit: "<<endl
            <<"Or (99 to clear all tasks .)"<<endl;
            int y ;
            bool p =true ;
           for(int i =0 ; i < tasks.size() ; i ++){
                cout<<i+1<<". "<<tasks[i]<<endl;
